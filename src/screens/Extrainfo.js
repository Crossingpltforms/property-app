    ...
    return (
      <ScrollView contentContainerStyle={ExtrainfoStyle.root}>
        ...
        <TextInput
          ...
          multiline={true}
          accessible={true}
          accessibilityLabel='extraInfoScreenDescInput'
        />
        ...
        <View style={ExtrainfoStyle.form}>
          ...
          <View style={ExtrainfoStyle.formInput}>
            <TextInput
              ...
              accessible={true}
              accessibilityLabel='extraInfoScreenDateInput'
            />
          </View>
        </View>
        ...
        <View style={ExtrainfoStyle.form}>
          ...
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityLabel='extraInfoMonthBtn'
          >
            <Text
              style={{
                fontSize: 9,
        ...
        >
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityLabel='extraInfoBackIconBtn'
          >
            <Icon
              name='arrow-back'
              size={15}
          ...
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityLabel='extraInfoNextBtn'
          >
