...
export default {
  ...
  photoBorder: {
    ...
    height: (width - Matrics.ScaleValue(20)) / 3.35,
    borderRadius: 5,
    borderColor: "#7D7D7D",
    borderWidth: 2,
    borderStyle: "dotted",
    ...
    marginHorizontal: Matrics.ScaleValue(4)
  ...
  photosWrapper: {
    width: (width - Matrics.ScaleValue(20)) / 3.35,
    height: (width - Matrics.ScaleValue(20)) / 2.6,
    justifyContent: "flex-start",
    alignItems: "center",
    marginVertical: height * 0.01,
    marginHorizontal: Matrics.ScaleValue(4)
  ...
  rotateIconView: {
    width: (width - Matrics.ScaleValue(20)) / 3.35 / 2,
    height: Matrics.ScaleValue(35),
    justifyContent: "center",
    alignItems: "center",
    paddingBottom: 10
