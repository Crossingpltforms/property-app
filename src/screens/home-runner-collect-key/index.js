...
class HomeRunnerCollectKey extends Component {
  constructor(props) {
    super(props)
    ...
    return (
      <View style={styles.formInputRoot}>
        ...
        <TextInput
          ...
          maxLength={textLimit}
          accessible={true}
          accessibilityLabel='homeRunnerCollKeyStateNameInput'
        />
  ...
  handleSave = () => {
    ...
    if (collectionAddress.trim() === '') {
      ...
      // let hoursText = (collectionTimeHours <= 12 ? collectionTimeHours : (collectionTimeHours - 12));
      // hoursText = (hoursText < 10 ? `0${hoursText}` : hoursText);
      // let minutesText = (collectionTimeMinutes < 10 ? `0${collectionTimeMinutes}` : collectionTimeMinutes);
        ...
        >
          ...
          >
            <View style={[styles.formInputRoot2, { marginRight: 10 }]}>
              ...
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityLabel='homeRunnerDateBtn'
              >
            ...
            <View style={[styles.formInputRoot2, { marginLeft: 10 }]}>
              ...
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityLabel='homeRunnerTimeBtn'
              >
                <Text style={styles.formInputText}>
          ...
          >
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityLabel='homeRunnerCollectKeyBtn'
            >
              <Text
                style={[
                  styles.text1,
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityLabel='homeRunnerClearIconBtn'
                >
              ...
              >
                <RadioForm
                  ...
                  accessible={true}
                  accessibilityLabel='homeRunnerCollectKeyRadioBtn'
                />
              </ScrollView>
            </View>
          </View>
...
export default HomeRunnerCollectKey
