export const trackerEventConfig = {
  ...
  postProperty: {
    ...
    action: {
      fillPropertyDetails: 'Filled_Property_Details',
      uploadPhotos: 'Uploaded Photos',
      fillExtraInfo: 'Filled_Extra_Information',
...
export const trackerEventSubmit = {
  ...
  postProperty: {
    ...
    action: {
      ...
      createListingClickPhotoContinue: 'CreateListing_Click_PhotoContinue',
      appPostProperty: 'App_Post_Property_WU800_5K'
    }
  },
  login: {
    category: 'Login',
